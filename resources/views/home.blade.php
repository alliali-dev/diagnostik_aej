                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex flex-column align-items-center pb-0">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h4 style="text-align: center;color: #f84702;text-transform: uppercase"> Donnees sur les rencontres Agence {{ Auth::user()->agence->name }}</h4>
                                </div>
                                <div class="col-lg-12" id="put_counter"><div id="counter_number" class="row" style="background: rgb(6, 169, 83);padding-top: 10px;">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <p class="txt-upper txt-align-center " style="color: white;font-size: 20px">Nombre d'inscrits</p>
                                        </div>
