                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-column align-items-start pb-0">
                            ...
                            <h2 class="text-bold-700 mt-1"><span class="badge badge-warning">{{--{{ number_format($etablissement, 0, ',', ' ') }}--}}</span></h2>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-column align-items-start pb-0">
                            ...
                            <h2 class="text-bold-700 mt-1"><span class="badge badge-success">{{--{{ number_format($eleve,0,',',' ') }}--}}</span></h2>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-column align-items-start pb-0">
                            ...
                            <h2 class="text-bold-700 mt-1"><span class="badge badge-danger">{{--{{ number_format($user,0,',',' ')}}--}}</span></h2>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="card">
                        <div class="card-header d-flex flex-column align-items-start pb-0">
                            ...
                            <h2 class="text-bold-700 mt-1"><span class="badge badge-info">{{--{{ $user_c->count() }}--}}</span></h2>
