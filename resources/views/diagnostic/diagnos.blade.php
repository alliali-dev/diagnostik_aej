                                ...
                                <!-- Step 1 -->
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nom_pnom_dem" id="nom_pnom_dem" placeholder="numero aej" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="datenaisance">Niveau de Formation</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                    ...
                                                    <label>
                                                        <input type="radio" name="niv_forma" id="niv_forma" value="secondaire">&nbsp;&nbsp;&nbsp;secondaire
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="niv_forma" id="niv_forma" value="superieur">&nbsp;&nbsp;&nbsp;superieur
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="datenaisance">Niveau d'expérience</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        <input type="radio" name="niv_exp" id="niv_exp" value="0 à 6 mois" checked>&nbsp;&nbsp;&nbsp;0 à 6 mois
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="niv_exp" id="niv_exp" value="6 mois à 1 an">&nbsp;&nbsp;&nbsp;6 mois à 1 an
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="niv_exp" id="niv_exp" value="1 à 2 ans">&nbsp;&nbsp;&nbsp;1 à 2 ans
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="niv_exp" id="niv_exp" value="2 ans et plus">&nbsp;&nbsp;&nbsp;2 ans et plus
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="datenaisance">Adéquation formation expérience</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        <input type="radio" name="adequa_form_exp" id="adequa_form_exp" value="Médiocre" checked>&nbsp;&nbsp;&nbsp;1
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adequa_form_exp" id="adequa_form_exp" value="Passable">&nbsp;&nbsp;&nbsp;2
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adequa_form_exp" id="adequa_form_exp" value="Assez bien">&nbsp;&nbsp;&nbsp;3
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adequa_form_exp" id="adequa_form_exp" value="Bien">&nbsp;&nbsp;&nbsp;4
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adequa_form_exp" id="adequa_form_exp" value="Très bien">&nbsp;&nbsp;&nbsp;5
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="datenaisance">Connaissance du métier / activité</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        <input type="radio" name="con_metier_activ" id="con_metier_activ" value="Médiocre" checked>&nbsp;&nbsp;1
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="con_metier_activ" id="con_metier_activ" value="Passable">&nbsp;&nbsp;2
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="con_metier_activ" id="con_metier_activ" value="Assez bien">&nbsp;&nbsp;3
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="con_metier_activ" id="con_metier_activ" value="Bien">&nbsp;&nbsp;4
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="con_metier_activ" id="con_metier_activ" value="Très bien">&nbsp;&nbsp;5
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="numpiece">Adéquation formation métier / activité</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        <input type="radio" name="adq_form_metier_activ" id="adq_form_metier_activ" value="Médiocre" checked>&nbsp;&nbsp;1
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adq_form_metier_activ" id="adq_form_metier_activ" value="Passable">&nbsp;&nbsp;2
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adq_form_metier_activ" id="adq_form_metier_activ" value="Assez bien">&nbsp;&nbsp;3
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adq_form_metier_activ" id="adq_form_metier_activ" value="Bien">&nbsp;&nbsp;4
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adq_form_metier_activ" id="adq_form_metier_activ" value="Très bien">&nbsp;&nbsp;5
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="nationalite">Adéquation expérience métier / activité</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        <input type="radio" name="adq_exp_metier_activ" id="adq_exp_metier_activ" value="Médiocre" checked>&nbsp;&nbsp;&nbsp;1
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adq_exp_metier_activ" id="adq_exp_metier_activ" value="Passable">&nbsp;&nbsp;&nbsp;2
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adq_exp_metier_activ" id="adq_exp_metier_activ" value="Assez bien">&nbsp;&nbsp;&nbsp;3
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adq_exp_metier_activ" id="adq_exp_metier_activ" value="Bien">&nbsp;&nbsp;&nbsp;4
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="adq_exp_metier_activ" id="adq_exp_metier_activ" value="Très bien">&nbsp;&nbsp;&nbsp;5
                                                    </label>
                                                </div>
                                            </div>
                                        </div><br><br><br>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="contact">Maîtrise de l'outils de recherche d'emploi</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        <input type="radio" name="mait_out_rech_empl" id="mait_out_rech_empl" value="Médiocre" checked>&nbsp;&nbsp;&nbsp;1
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="mait_out_rech_empl" id="mait_out_rech_empl" value="Passable">&nbsp;&nbsp;&nbsp;2
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="mait_out_rech_empl" id="mait_out_rech_empl" value="Assez bien">&nbsp;&nbsp;&nbsp;3
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="mait_out_rech_empl" id="mait_out_rech_empl" value="Bien">&nbsp;&nbsp;&nbsp;4
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="mait_out_rech_empl" id="mait_out_rech_empl" value="Très bien">&nbsp;&nbsp;&nbsp;5
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="lieudereisdence">Connaissance des exigence du marché</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        <input type="radio" name="con_exig_march" id="con_exig_march" value="Médiocre" checked>&nbsp;&nbsp;&nbsp;1
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="con_exig_march" id="con_exig_march" value="Passable">&nbsp;&nbsp;&nbsp;2
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="con_exig_march" id="con_exig_march" value="Assez bien">&nbsp;&nbsp;&nbsp;3
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="con_exig_march" id="con_exig_march" value="bien">&nbsp;&nbsp;&nbsp;4
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="con_exig_march" id="con_exig_march" value="Très bien">&nbsp;&nbsp;&nbsp;5
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="diplome">Dépôtde dossier en entreprise</label>
                                                </div>
                                                <div class="form-group">
                                                    <label>
                                                        <input type="radio" name="dep_doss_ent" id="dep_doss_ent" value="pas du tout" checked>&nbsp;&nbsp;&nbsp;pas du tout
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="dep_doss_ent" id="dep_doss_ent" value="souvent">&nbsp;&nbsp;&nbsp;souvent
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="dep_doss_ent" id="dep_doss_ent" value="régulièrement">&nbsp;&nbsp;&nbsp;régulièrement
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
