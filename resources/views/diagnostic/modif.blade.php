...
<div class="tab-content layout-row">
    <div class="tab-pane layout-cell active" id="tabs1498-tab-01661944692659">
        ...
        <div class="field-section">
            ...
            <hr>
        <div class="row">
            <div class="form-group  widget-field span-left col-6  " data-field-name="datedebutchomage" id="Form-field-DemandeurEmploiModel-datedebutchomage-group">
                <label for="Form-field-DemandeurEmploiModel-datedebutchomage">
                    Date début chomage
                </label>
                <!-- Widget -->
                <div id="DatePicker-formDatedebutchomage-datedebutchomage" class="field-datepicker" data-control="datepicker" data-mode="date" data-show-week-number="" data-disposable="">
                    <!-- Date -->
                    <div class="input-with-icon right-align">
                        <i class="icon icon-calendar-o"></i>
                        <input type="date" id="DatePicker-formDatedebutchomage-date-datedebutchomage" class="form-control align-right" autocomplete="off" data-datepicker="">
                    </div>

                    <!-- Data locker -->
                    <input type="hidden" name="DemandeurEmploiModel[datedebutchomage]" id="Form-field-DemandeurEmploiModel-datedebutchomage" value="" data-datetime-value="">
            ...
            <div class="form-group  widget-field span-right col-6  " data-field-name="motifinscription" id="Form-field-DemandeurEmploiModel-motifinscription-group">
                ...
                <div class="relation-widget" id="">
                    <!-- Dropdown -->
                    <select id="Form-field-DemandeurEmploiModel-motifinscription" name="DemandeurEmploiModel[motifinscription]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="false">
        ...
        <div class="row">
            ...
            <div class="relation-widget" id="Relation-formTypesituationhandicap-typesituationhandicap">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-typesituationhandicap" name="DemandeurEmploiModel[typesituationhandicap]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  text-field span-right col-6  " data-field-name="handicapdemandeur" id="Form-field-DemandeurEmploiModel-handicapdemandeur-group"><label for="Form-field-DemandeurEmploiModel-handicapdemandeur">
            ...
            <!-- Text -->
            <input type="text" name="DemandeurEmploiModel[handicapdemandeur]" id="Form-field-DemandeurEmploiModel-handicapdemandeur" value="" placeholder="" class="form-control" autocomplete="off" maxlength="255">
        </div>
        </div>
       <div class="row">
       <div class="form-group  widget-field span-left  col-6 " data-field-name="categoriedemandeur" id="Form-field-DemandeurEmploiModel-categoriedemandeur-group"><label for="Form-field-DemandeurEmploiModel-categoriedemandeur">
            ...
            <div class="relation-widget" id="Relation-formCategoriedemandeur-categoriedemandeur">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-categoriedemandeur" name="DemandeurEmploiModel[categoriedemandeur]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  widget-field span-right col-6   " data-field-name="conseilleremploi" id="Form-field-DemandeurEmploiModel-conseilleremploi-group"><label for="Form-field-DemandeurEmploiModel-conseilleremploi">
            ...
            <div class="relation-widget" id="Relation-formConseilleremploi-conseilleremploi">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-conseilleremploi" name="DemandeurEmploiModel[conseilleremploi]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
       ...
       <div class="form-group  text-field span-left col-6  " data-field-name="nocnps" id="Form-field-DemandeurEmploiModel-nocnps-group">
            ...
            <!-- Text -->
            <input type="text" name="DemandeurEmploiModel[nocnps]" id="Form-field-DemandeurEmploiModel-nocnps" value="" placeholder="" class="form-control" autocomplete="off" maxlength="255">
        </div>
       ...
       <div class="form-group  widget-field span-left col-6  " data-field-name="datenaissance" id="Form-field-DemandeurEmploiModel-datenaissance-group"><label for="Form-field-DemandeurEmploiModel-datenaissance">
            ...
            <div id="DatePicker-formDatenaissance-datenaissance" class="field-datepicker" data-control="datepicker" data-mode="date" data-show-week-number="" data-disposable="">
                ...
                <!-- Data locker -->
                <input type="hidden" name="DemandeurEmploiModel[datenaissance]" id="Form-field-DemandeurEmploiModel-datenaissance" value="1986-03-26 00:00:00" data-datetime-value="">
        ...
        <div class="form-group  widget-field span-right col-6  " data-field-name="tlieunaissance" id="Form-field-DemandeurEmploiModel-tlieunaissance-group"><label for="Form-field-DemandeurEmploiModel-tlieunaissance">
            ...
            <div class="relation-widget" id="Relation-formTlieunaissance-tlieunaissance">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-tlieunaissance" name="DemandeurEmploiModel[tlieunaissance]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
       ...
       <div class="form-group  widget-field span-left col-6  " data-field-name="paysnationalite" id="Form-field-DemandeurEmploiModel-paysnationalite-group"><label for="Form-field-DemandeurEmploiModel-paysnationalite">
            ...
            <div class="relation-widget" id="Relation-formPaysnationalite-paysnationalite">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-paysnationalite" name="DemandeurEmploiModel[paysnationalite]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  widget-field span-right col-6  " data-field-name="sexe" id="Form-field-DemandeurEmploiModel-sexe-group"><label for="Form-field-DemandeurEmploiModel-sexe">
            ...
            <div class="relation-widget" id="Relation-formSexe-sexe">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-sexe" name="DemandeurEmploiModel[sexe]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
       ...
       <div class="form-group  widget-field span-left col-6  " data-field-name="situationmatrimoniale" id="Form-field-DemandeurEmploiModel-situationmatrimoniale-group"><label for="Form-field-DemandeurEmploiModel-situationmatrimoniale">
            ...
            <div class="relation-widget" id="Relation-formSituationmatrimoniale-situationmatrimoniale">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-situationmatrimoniale" name="DemandeurEmploiModel[situationmatrimoniale]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  widget-field span-left col-6 " data-field-name="typepieceidentite" id="Form-field-DemandeurEmploiModel-typepieceidentite-group"><label for="Form-field-DemandeurEmploiModel-typepieceidentite">
            ...
            <div class="relation-widget" id="Relation-formTypepieceidentite-typepieceidentite">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-typepieceidentite" name="DemandeurEmploiModel[typepieceidentite]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  text-field span-right col-6 is-required  " data-field-name="numerocni" id="Form-field-DemandeurEmploiModel-numerocni-group"><label for="Form-field-DemandeurEmploiModel-numerocni">
            ...
            <!-- Text -->
            <input type="text" name="DemandeurEmploiModel[numerocni]" id="Form-field-DemandeurEmploiModel-numerocni" value="C0071513137" placeholder="" class="form-control" autocomplete="off" maxlength="255" required="">
        </div>
       ...
       <div class="form-group  text-field span-left col-6  " data-field-name="divisionregionale" id="Form-field-DemandeurEmploiModel-divisionregionale-group"><label for="Form-field-DemandeurEmploiModel-divisionregionale">
            ...
            <!-- Text -->
            <input type="text" name="DemandeurEmploiModel[divisionregionale]" id="Form-field-DemandeurEmploiModel-divisionregionale" value="YOPOUGON" placeholder="" class="form-control" autocomplete="off" maxlength="255" disabled="disabled">
        </div>
        <div class="form-group  widget-field span-right col-6  " data-field-name="paysresidence" id="Form-field-DemandeurEmploiModel-paysresidence-group"><label for="Form-field-DemandeurEmploiModel-paysresidence">
            ...
            <div class="relation-widget" id="Relation-formPaysresidence-paysresidence">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-paysresidence" name="DemandeurEmploiModel[paysresidence]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
       ...
       <div class="form-group  widget-field span-left col-6  " data-field-name="villeresidence" id="Form-field-DemandeurEmploiModel-villeresidence-group"><label for="Form-field-DemandeurEmploiModel-villeresidence">
            ...
            <div class="relation-widget" id="Relation-formVilleresidence-villeresidence">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-villeresidence" name="DemandeurEmploiModel[villeresidence]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  widget-field span-right col-6  " data-field-name="agencecnps" id="Form-field-DemandeurEmploiModel-agencecnps-group"><label for="Form-field-DemandeurEmploiModel-agencecnps">
            ...
            <div class="relation-widget" id="Relation-formAgencecnps-agencecnps">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-agencecnps" name="DemandeurEmploiModel[agencecnps]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
       ...
       <div class="row">
            ...
            <div class="relation-widget" id="Relation-formTlieuhabitation-tlieuhabitation">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-tlieuhabitation" name="DemandeurEmploiModel[tlieuhabitation]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  text-field span-left col-6  " data-field-name="nomdupere" id="Form-field-DemandeurEmploiModel-nomdupere-group"><label for="Form-field-DemandeurEmploiModel-nomdupere">
            ...
            <!-- Text -->
            <input type="text" name="DemandeurEmploiModel[nomdupere]" id="Form-field-DemandeurEmploiModel-nomdupere" value="Ani gbalou Félix" placeholder="" class="form-control" autocomplete="off" maxlength="255">
        </div>
        <div class="form-group  text-field span-right col-6  " data-field-name="nomdelamere" id="Form-field-DemandeurEmploiModel-nomdelamere-group"><label for="Form-field-DemandeurEmploiModel-nomdelamere">
            ...
            <!-- Text -->
            <input type="text" name="DemandeurEmploiModel[nomdelamere]" id="Form-field-DemandeurEmploiModel-nomdelamere" value="Gnepo zrohonon Martine" placeholder="" class="form-control" autocomplete="off" maxlength="255">
        </div>
        </div>
        ...
        <div class="form-group  widget-field span-left col-6   " data-field-name="niveauetude" id="Form-field-DemandeurEmploiModel-niveauetude-group"><label for="Form-field-DemandeurEmploiModel-niveauetude">
            ...
            <div class="relation-widget" id="Relation-formNiveauetude-niveauetude">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-niveauetude" name="DemandeurEmploiModel[niveauetude]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  widget-field span-right col-6  " data-field-name="diplome" id="Form-field-DemandeurEmploiModel-diplome-group"><label for="Form-field-DemandeurEmploiModel-diplome">
            ...
            <div class="relation-widget" id="Relation-formDiplome-diplome">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-diplome" name="DemandeurEmploiModel[diplome]" class="form-control custom-select select2-accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  widget-field span-left col-6  " data-field-name="paysdiplome" id="Form-field-DemandeurEmploiModel-paysdiplome-group"><label for="Form-field-DemandeurEmploiModel-paysdiplome">
            ...
            <div class="relation-widget" id="Relation-formPaysdiplome-paysdiplome">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-paysdiplome" name="DemandeurEmploiModel[paysdiplome]" class="form-control custom-select select2--accessible" data-placeholder="" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  text-field span-right col-6  " data-field-name="etablissementfrequente" id="Form-field-DemandeurEmploiModel-etablissementfrequente-group"><label for="Form-field-DemandeurEmploiModel-etablissementfrequente">
            ...
            <!-- Text -->
            <input type="text" name="DemandeurEmploiModel[etablissementfrequente]" id="Form-field-DemandeurEmploiModel-etablissementfrequente" value="" placeholder="" class="form-control" autocomplete="off" maxlength="255">
        </div>
        </div>
       <div class="row">
       <div class="form-group  widget-field span-left col-6  " data-field-name="typeenseignement" id="Form-field-DemandeurEmploiModel-typeenseignement-group"><label for="Form-field-DemandeurEmploiModel-typeenseignement">
            ...
            <div class="relation-widget" id="Relation-formTypeenseignement-typeenseignement">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-typeenseignement" name="DemandeurEmploiModel[typeenseignement]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  widget-field span-right col-6  " data-field-name="typeetablissement" id="Form-field-DemandeurEmploiModel-typeetablissement-group"><label for="Form-field-DemandeurEmploiModel-typeetablissement">
            ...
            <div class="relation-widget" id="Relation-formTypeetablissement-typeetablissement">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-typeetablissement" name="DemandeurEmploiModel[typeetablissement]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
       ...
       <div class="form-group  widget-field span-left col-6  " data-field-name="competence" id="Form-field-DemandeurEmploiModel-competence-group"><label for="Form-field-DemandeurEmploiModel-competence">
            ...
            <div class="relation-widget" id="Relation-formCompetence-competence">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-competence" name="DemandeurEmploiModel[competence]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  widget-field span-right col-6   " data-field-name="specialite" id="Form-field-DemandeurEmploiModel-specialite-group"><label for="Form-field-DemandeurEmploiModel-specialite">
            ...
            <div class="relation-widget" id="Relation-formSpecialite-specialite">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-specialite" name="DemandeurEmploiModel[specialite]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
        ...
        <div class="form-group  number-field span-left col-6  " data-field-name="nombreexperience" id="Form-field-DemandeurEmploiModel-nombreexperience-group"><label for="Form-field-DemandeurEmploiModel-nombreexperience">
            ...
            <input type="number" step="any" name="DemandeurEmploiModel[nombreexperience]" id="Form-field-DemandeurEmploiModel-nombreexperience" value="" placeholder="" class="form-control" autocomplete="off" pattern="-?\d+(\.\d+)?" maxlength="255">
        </div>
        <div class="form-group  widget-field span-right col-6  " data-field-name="uniteexperience" id="Form-field-DemandeurEmploiModel-uniteexperience-group"><label for="Form-field-DemandeurEmploiModel-uniteexperience">
            ...
            <div class="relation-widget" id="Relation-formUniteexperience-uniteexperience">
                <!-- Dropdown -->
                <select id="Form-field-DemandeurEmploiModel-uniteexperience" name="DemandeurEmploiModel[uniteexperience]" class="form-control custom-select select2-accessible" data-placeholder="sélectionnez" data-disposable="data-disposable" tabindex="-1" aria-hidden="true">
                    <option value="">sélectionnez</option>
       ...
       <div class="row">
            <div class="form-group  text-field span-left col-6  " data-field-name="expertise" id="Form-field-DemandeurEmploiModel-expertise-group"><label for="Form-field-DemandeurEmploiModel-expertise">
                ...
                <!-- Text -->
                <input type="text" name="DemandeurEmploiModel[expertise]" id="Form-field-DemandeurEmploiModel-expertise" value="" placeholder="" class="form-control" autocomplete="off" maxlength="255">
            </div>
